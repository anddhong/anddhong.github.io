...
img.onclick = function() {
  let src = img.getAttribude('src');
  if (src==='img/portfolio/thumbnails/1.jpg') {
    window.location = 'https://open.spotify.com/playlist/5RlwXzvJBAAyhEpgqjNbS7?si=_JQzLTVSQW2kWagqdA63jQ';
  } else {
    window.location = 'https://open.spotify.com/playlist/5RlwXzvJBAAyhEpgqjNbS7?si=_JQzLTVSQW2kWagqdA63jQ';
  }
}
